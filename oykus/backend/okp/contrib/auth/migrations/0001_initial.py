# Generated by Django 5.1.6 on 2025-02-16 16:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', okp.core.fields.OkpImageField(blank=True, null=True, upload_to='users/avatars', validators=[okp.core.validators.okp_image_size_validator, django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'webp'])], verbose_name='Avatar')),
                ('cover', okp.core.fields.OkpImageField(blank=True, null=True, upload_to='users/covers', validators=[okp.core.validators.okp_image_size_validator, django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'webp'])], verbose_name='Cover')),
